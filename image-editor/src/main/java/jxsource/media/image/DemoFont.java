...
public class DemoFont {
  ...
  private static String[] names = { "simfang.TTF" };
  ...
  public static Font getFont(String name) {
    ...
    String fName = "c:/Windows/Fonts/" + name;
    System.out.println(new File(fName).exists());
    try {
      InputStream is = new FileInputStream(fName);//DemoFont.class.getResourceAsStream(fName);
