...
public class BridgeProxyClientApp implements Runnable{
	...
	public static void main(String[] args) {
		new Thread(new BridgeProxyClientApp()).start();
//		new Thread(new HttpProxyClientApp()).start();
	}
	...
	public void run() {
		try {
//			byte[] b = postProxyResult("http://localhost:10090/ContentLength");
//			System.out.println(Thread.currentThread().getName()+": "+new String(b));
//			System.out.println(trans("http://localhost:10090/ContentLength"));
/*			trans("http://localhost:10090/LargeChunked");
			...
			trans("http://localhost:10090/LargeChunked");
*/			
//			System.out.println(trans("http://bridge__localhost__port__80"));
			System.out.println(trans("http://bridge__localhost__port__10090__bridge"));
			System.out.println(trans("http://bridge__localhost__port__10090__bridge/Chunked"));
			System.out.println(trans("http://bridge__http__host__localhost__port__10090__bridge"));
